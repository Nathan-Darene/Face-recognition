...
# Définir un seuil pour la correspondance des visages
tolerance_threshold = 0.6  # Plus bas = plus strict, plus haut = plus tolérant
...
while True:
    ...
    for face_encoding, (top, right, bottom, left) in zip(face_encodings, face_locations):
        ...
        print(f"Distances des visages : {face_distances}")

        # Trouver l'indice du visage avec la plus petite distance
        best_match_index = np.argmin(face_distances)
        
        # Vérifier si la correspondance est suffisamment proche selon le seuil
